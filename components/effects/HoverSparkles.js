...
function usePrefersReducedMotion() {
    ...
    // No-op for now, can be improved for accessibility
...
const HoverSparkles = ({
    ...
    const allColors = colors.map((n) => theme.colors[n] || n);
    ...
    useRandomInterval(
        ...
        hovered && !prefersReducedMotion ? 50 : null,
        hovered && !prefersReducedMotion ? 250 : null,
    );
