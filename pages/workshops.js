...
const demoEvents = [
  {
    ...
    date: "2025-02-15",
    tags: ["Beginner", "JavaScript", "Web Development"],
    description:
      "Learn the fundamentals of JavaScript programming. Perfect for beginners who want to start their coding journey.",
    location: "Butwal Community Center",
    link: "#",
  ...
  },
  {
    ...
    description: "Master version control with Git and learn to collaborate on GitHub.",
    location: "Butwal Community Center",
    link: "#",
    ...
    <>
      ...
      >
        <Container>
          ...
          <Text sx={{ fontSize: [2, 3], maxWidth: "600px", mx: "auto", opacity: 0.95 }}>
            Join our hands-on workshops and community events to learn new skills, build projects, and connect with
      ...
      <Container sx={{ py: [4, 5] }}>
        ...
        <Box sx={{ mb: 5 }}>
          ...
          >
            <Button variant={filter === "all" ? "primary" : "outline"} onClick={() => setFilter("all")} sx={{ mb: 2 }}>
            ...
            {pastEvents.length > 0 && (
              <Box sx={{ mb: 6 }}>
                <Flex sx={{ alignItems: "center", mb: 4 }}>
                  ...
                  <Badge variant="outline" sx={{ px: 3, py: 1, fontSize: 1, borderColor: "muted", color: "black" }}>
        ...
        >
          ...
          <Text sx={{ mb: 4, maxWidth: "600px", mx: "auto", color: "black" }}>
            ...
            Whether you're an expert in a particular technology or just passionate about sharing knowledge, we'd love to
            hear from you.
          </Text>
          ...
          <Grid columns={[1, 2, 3]} gap={4}>
            ...
            >
              ...
              <Text sx={{ fontSize: 1, color: "black" }}>
                All our workshops are designed to be accessible to beginners. No prior experience required!
              </Text>
            </Box>
