      ...
      <Container sx={{ py: [4, 5] }}>
        ...
        {isLoading ? (
          ...
          <Box sx={{ textAlign: "center", py: 4 }}>
            <Text sx={{ color: "#D32F2F", mb: 2 }}>{error}</Text>
            ...
            {pastEvents.length > 0 && (
              <Box sx={{ mb: 6 }}>
                <Flex sx={{ alignItems: "center", mb: 4 }}>
                  ...
                  <Badge variant="outline" sx={{ px: 3, py: 1, fontSize: 1, borderColor: "#E0E0E0", color: "black" }}>
