...
export default function Home() {
    ...
    return (
        <>
            ...
            >
                <Container>
                    <Grid columns={[1, null, 2]} gap={[4, 5]} sx={{alignItems: "center"}}>
                        <Box>
                            <Heading
                                as="h1"
                                sx={{
                            ...
                            >
                                Join Nepal's most vibrant community of young coders, makers, and innovators. Learn,
                                build, and ship
            ...
            >
                <Container>
                    ...
                    >
                        Join hundreds of students who are already building the future. Your coding adventure starts
                        here!
                    </Text>
