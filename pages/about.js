        ...
        <>
            <Head>
                ...
                <meta name="description"
                      content="Learn about HackClub Butwal - Empowering the next generation of coders, makers, and innovators in Butwal, Nepal."/>
            </Head>
            ...
            <Box as="main" sx={{pt: [6, 7]}}>
                ...
                <Box sx={{py: [4, 5]}}>
                    <Container>
                        <Heading as="h2"
                                 sx={{fontSize: [3, 4], textAlign: "center", mb: 4, fontWeight: 700, color: "#2C3E50"}}>
                            Our Story
                        </Heading>
                        <Grid columns={[1, 2]} gap={4} sx={{alignItems: "center"}}>
                            <Box>
                                <Text sx={{fontSize: [2, 3], lineHeight: 1.6, mb: 3, color: "#2C3E50"}}>
                                    HackClub Butwal was born from a simple yet powerful idea: every student should have
                                    access to
                                ...
                                <Text sx={{fontSize: [2, 3], lineHeight: 1.6, mb: 3, color: "#2C3E50"}}>
                                    ...
                                    community of over 40+ active members, hosting regular workshops, hackathons, and
                                    tech events.
                                </Text>
                                <Text sx={{fontSize: [2, 3], lineHeight: 1.6, mb: 3, color: "#2C3E50"}}>
                                    Today, we're proud to be fostering the next generation of developers, innovators,
                                    and
                            ...
                            <Box sx={{textAlign: "center", p: 4, bg: "#F8F9FA", borderRadius: 2}}>
                                <Box
                                    sx={{
                                        ...
                                        mx: "auto",
                                        mb: 3,
                                        backgroundImage: "url('/assets/favicon/3.jpg')",
                        ...
                        <Grid columns={[1, 2]} gap={4}>
                            ...
                            >
                                ...
                                <Text sx={{fontSize: [1, 2], lineHeight: 1.6}}>
                                    ...
                                    collaborative spirit needed to become the next generation of technology leaders and
                                    innovators.
                                </Text>
                            </Box>
                            <Box
                            ...
                            >
                                ...
                                <Text sx={{fontSize: [1, 2], lineHeight: 1.6}}>
                                    A world where every young person has access to world-class technology education and
                                    the
                ...
                <Box sx={{py: [4, 5], bg: "#F8F9FA"}}>
                    <Container>
                        ...
                        <Grid columns={[2, 3, 5]} gap={3}>
                            {[
                                {icon: "👥", number: "40+", label: "Active Members"},
                                {icon: "🎓", number: "10", label: "Workshops"},
                                {icon: "🚀", number: "5", label: "Projects Built"},
                                {icon: "🎉", number: "3", label: "Events"},
                                {icon: "💻", number: "100+", label: "Lines of Code"}
                        ...
                        <Box sx={{maxWidth: 800, mx: "auto"}}>
                            {[
                                ...
                                <Flex key={index} sx={{alignItems: "flex-start", mb: 4}}>
                                    ...
                                    <Box>
                                        <Heading as="h3"
                                                 sx={{fontSize: [2, 3], fontWeight: 700, mb: 2, color: "#2C3E50"}}>
                                            {milestone.title}
                                        </Heading>
                                        <Text sx={{color: "#7F8C8D", lineHeight: 1.6, fontSize: [1, 2]}}>
