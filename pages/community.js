    ...
    return (
        <>
            ...
            <Container sx={{py: [4, 5]}}>
                ...
                {/* Team Section */}
                <Heading as="h2" sx={{mb: 4, textAlign: "center", fontSize: [4, 5], color: "black"}}>
                    Meet The Team
                </Heading>
                ...
                {isLoading ? (
                    <Flex sx={{justifyContent: "center", py: 5}}>
                        <Spinner size={48}/>
                        <Text sx={{ml: 3, color: "black"}}>Loading team members...</Text>
                    </Flex>
                ) : error ? (
                    ...
                    <Grid columns={[1, null, 2, 4]} gap={4} sx={{mb: 6}}>
                        {members.map((member) => (
                ...
                >
                    ...
                    <Grid columns={[1, 2, 4]} gap={3} sx={{mb: 4}}>
                        ...
                        >
                            ...
                            <Text sx={{fontSize: 1, color: "black"}}>Join workshops, build projects, and learn with
                                peers.</Text>
                        </Box>
                        <Box
                            sx={{
                        ...
                        >
                            ...
                            <Text sx={{fontSize: 1, color: "black"}}>Share your knowledge and help guide the next
                                generation.</Text>
                        </Box>
                        <Box
                            sx={{
                        ...
                        >
                            ...
                            <Text sx={{fontSize: 1, color: "black"}}>Help plan events and grow the community in
                                Butwal.</Text>
                        </Box>
                    </Grid>
